...
1. 在CTeX套装或者TeXLive发行版（请使用不高于TeXLive2014的版本）下推荐使用 XeLaTeX 编译。
   表格图像编号需要连续编译两次才能正常显示；
   参考文献需要按照XeLaTeX-XeLaTeX-BibTeX-XeLaTeX的顺序编译四次。
...
3. 引用参考文献为\cite{}命令，效果为右上角标。

========
如何升级
========
1. 下载新模板并解压缩
2. 将bnuthesis.cls, bnuthesis.cfg, bnubib.bst, 及bnutils.sty四个文件替换即可。

==========
更新日志
==========
2016-04-10 更新为1.54。增加横排表格示例；移除表格字体字号限制，可自行调整表格字号大小；移除Adobe字体，默认使用windows系统中文字体。
2015-09-20 更新为1.53。按2015年新版论文规范更新。增加openright|openany选项；修正章节名称，附录名称，图表编号，目录字体等多处细节。
